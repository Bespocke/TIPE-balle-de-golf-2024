...
INFLOW_PADDING = 50
INFLOW_DURATION = 30
INFLOW_RADIUS = 10  # Modifier le rayon de la balle ici (augmenter à 24 par exemple)
INFLOW_VELOCITY = 2
INFLOW_COUNT = 1
...
for f in range(DURATION):
    ...
    # Interagir avec la balle solide en définissant sa position dans le champ de vélocité
    ...
    # Mettre à jour la position de la balle dans le champ de vélocité
    fluid.velocity[:, fluid.ball_mask] = inflow_velocity[:, fluid.ball_mask]
